      ...
      <div class="card mb-3 mt-4" id="testTable" style="border: 1px solid;" >
        <div class="card-header" >
          <i class="fa fa-table"></i> &nbsp;
            <strong>Defaulter List</strong>
           <div style="float: right;"> <?php echo date('d-m-Y'); ?>
        </div>
        <div class="card-body">
          <div class="table-responsive" id="divName"><!-- id="testTable" -->
            <table class="table table-bordered"  width="100%" cellspacing="0">
              ...
              <tbody>
                <?php $i=1; if (isset($defList)): foreach($defList as $v): ?>
                <tr>
                  <td><?php echo $i++; ?></td>
                  ...
                  <td>
                  	<?php $total_arrear=0;
	                   echo $v['arrear_amount'];
	                   $total_arrear=$total_arrear+$v['arrear_amount'];
                    ?></td> 
              ...
              <?php endforeach; endif; ?>
               <tr class="bg-dark text-white">
                ...
                <td colspan="2"><strong><?php echo $total_arrear; ?></strong></td>
              </tr>
              </tbody>
            </table>
          </div>
