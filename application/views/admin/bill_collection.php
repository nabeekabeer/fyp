        ...
        <?php //if(isset($mge)){ echo $mge;}else{ echo 'nothing';};?>
          <div class="form-group">
              <div class="col-md-12">
                ...
                <?php echo form_input(['type'=>'text','name'=>'receiving_point_name','placeholder'=>'Receiving Point Name',"value"=>"",'class'=>'form-control','title'=>'Receiving Point name']);
        ...
        <?php echo form_open('myController/updateMeterType'); ?>
          <div class="form-group">
              <div class="col-md-12">
                ...
                <!--input type="text" name="area_name" value="" class="form-control"-->
                <?php echo form_input(['type'=>'text','name'=>'meter_type_name',"value"=>"$mtname",'class'=>'form-control','title'=>'meter type name']);
