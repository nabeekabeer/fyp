<script type="text/javascript">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark  fixed-top bg-dark" id="mainNav">
   ...
   <?= anchor("myController/home","<img src='http://[::1]/my_fyp/asset/images/uob.jpg' style='border-radius:6px;' height='40' width='50'> &nbsp; &nbsp; Electricity Billing Management System",['class'=>'navbar-brand img-circle']); ?>
          ...
          <ul class="sidenav-second-level collapse" id="collapseMulti" >
            ...
            <li>
              ...
              <ul class="sidenav-third-level collapse" id="collapseMulti4" >
                ...
                <li>
                 <?= anchor("myController/editConsumerDetail","View All Connection"); ?>
                </li>
              </ul>
            </li>
            <li>
